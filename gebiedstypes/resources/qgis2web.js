...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [112101.389140, 473607.244121, 138278.050659, 491567.625371], maxZoom: 28, minZoom: 1, projection: 'EPSG:28992'
    })
});

map.getView().fit([112101.389140, 473607.244121, 138278.050659, 491567.625371], map.getSize());
