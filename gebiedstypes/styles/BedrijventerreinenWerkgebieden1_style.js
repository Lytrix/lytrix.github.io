var size = 0;
function categories_BedrijventerreinenWerkgebieden1(feature, value, size) {
                switch(value) {case 'b':
...
case 'K':
        ...
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.51)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(87,150,228,0.51)'})
                    ...
                    break;}};
var styleCache_BedrijventerreinenWerkgebieden1={}
var style_BedrijventerreinenWerkgebieden1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_BedrijventerreinenWerkgebieden1(feature, value, size);
    key = value + "_" + labelText
    if (!styleCache_BedrijventerreinenWerkgebieden1[key]){
        ...
        styleCache_BedrijventerreinenWerkgebieden1[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_BedrijventerreinenWerkgebieden1[key]];
